...
const History = () => {
    ...
    useEffect(() => {
        ApiClient.get('/videos/history', { params: { limit: 200 } })
    ...
    return (
        <div className="min-h-screen pt-24 px-4 md:px-8 max-w-[1200px] mx-auto">
            <div className="flex items-center gap-4 mb-8 border-b border-white/10 pb-6">
                ...
                <div>
                    <h1 className="text-2xl font-black tracking-tight mb-1">Watch History</h1>
                    <p className="text-white/50 text-sm">Videos you have watched in the past.</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="py-20 text-center flex flex-col items-center">
                    ...
                    <p className="text-lg font-bold text-white/50">No watch history yet</p>
                    <p className="text-sm text-white/30 mt-1">Videos you watch will appear here.</p>
